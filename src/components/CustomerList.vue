<template>
    <div class="container-fluid">
      ...
      <div class="d-md-none" id="collapsable-card" style="width: 80%">
        ...
        <div class="card" v-for="customer in customers" :key="customer">
          ...
          <div :id="'collapse' + customer.pk" class="collapse" :aria-labelledby="'heading' + customer.pk" data-bs-parent="#collapsable-card">
            <div class="card-body">
              ...
              <p><b>Address:</b> {{ customer.address }},{{ customer.city }}, {{ customer.state }}, {{ customer.zipcode }}</p>
        ...
        <table class="table table-hover" style="overflow-y: auto" :headers="headers">
          ...
          <tbody>
            <tr v-for="customer in customers" :key="customer">
              ...
              <td v-if="(this.userID === customer.agent || this.is_superuser === 'true')" @click="updateCustomer(customer)">
              ...
              <td v-if="(this.userID === customer.agent || this.is_superuser === 'true')" @click="deleteCustomer(customer)">
                <button style="background-color: transparent; padding: 5;">
                  <font-awesome-icon icon="trash" />
                </button>
              </td>
